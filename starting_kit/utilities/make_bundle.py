...
class Bundle:
	...
	def check(self):
		...
		command_ingestion = 'python {} {} {} {} {} {}'.format(path_ingestion, data_dir, self.sample_result_submission, self.ingestion_program, self.sample_code_submission, 'deep_pollination')
		...
		command_scoring = 'python {} {} {} {} {} {}'.format(path_scoring, data_dir, self.sample_result_submission, self.scoring_output, self.ingestion_program, 'deep_pollination')
